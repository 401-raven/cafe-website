      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="relative w-11 h-11 rounded-full overflow-hidden shadow-md group-hover:shadow-lg transition-shadow border-2 border-primary/20">
              <img
                src={dezzoveLogo}
                alt="Dezzove Logo"
            ...
            {navLinks.map((link) => {
              ...
              return (
                <li key={link.label}>
                  ...
                  >
                    {isActive && (
                      <span className="absolute inset-0 rounded-full bg-primary-gradient" />
                    )}
