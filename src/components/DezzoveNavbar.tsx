      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="relative w-10 h-10 rounded-full overflow-hidden shadow-md group-hover:shadow-lg transition-shadow" style={{ border: "2px solid rgba(28,167,184,0.15)" }}>
              <img
                src={dezzoveLogo}
                alt="Dezzove Logo"
                ...
                <li key={link.label}>
                  <Link
                    ...
                    className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${isActive
                      ? "text-white"
                      : "text-muted-foreground hover:text-dz-chocolate"
                      }`}
                  >
                    {isActive && (
                      <span className="absolute inset-0 rounded-full bg-dz-chocolate" />
                    )}
              ...
              return (
                <li key={link.label}>
                  <Link
                    ...
                    className={`block px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${isActive
                      ? "text-white bg-dz-chocolate"
